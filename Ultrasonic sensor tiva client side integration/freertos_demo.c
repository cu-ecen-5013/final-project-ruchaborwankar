...
//xSemaphoreHandle g_pUARTSemaphore;      //for uart
//TimerHandle_t Timer;
//TickType_t ticks_1_start,ticks_1_stop,ticks_2_start,ticks_2_stop;
////typedef struct AMessage{
////   int qMessageID;
////   int qData;
////}xMessage;
...
//                   {
//                             xSemaphoreTake(g_pUARTSemaphore, portMAX_DELAY);
//                             UARTprintf("Data received is data=%d\n",rec_data);
//                             xSemaphoreGive(g_pUARTSemaphore);
//                             send_to_bb(rec_data);
//
//
...
//    if(count%50==0)
//        {
//           if(xSemaphoreGive(sem2)!= pdPASS)
//           {
//               UARTprintf("***************SemaphoreGive failed********************\n");
//           }
//        }
//
//}
...
//                         xSemaphoreGive(g_pUARTSemaphore);
//                  }
//       Timer=xTimerCreate("Timer",                 //timer name
//                             pdMS_TO_TICKS(20),     //ticks
//                             pdTRUE,                  //auto reload
//                             (void*)0,                //timer id
//                             vTimerCallback);         //timer function
//
//          if(Timer == NULL)
//              {
//                  UARTprintf("***********Timer1 not created*******************\n");
//              }
//          xTimerStart(Timer,0);
//       //give semaphore 1 to initiate the sending of data to queue using sensor data
//       xSemaphoreGive(sem1);
