 ...
 *                             Ultrasonic sensor working with motor feedback system
 *
 ...
 * A dc motor with a motor driver is interfaced at PA 4 pin and is toggled depending on the readings of ultrasonic sensor.
 * If the readings are less than 15cm then it stops the motor and as ultrasonic data output increases above 15cm it starts the motor again thus controlling
 * the output.
 *
 ***************************************************************************************/
#include <stdbool.h>
